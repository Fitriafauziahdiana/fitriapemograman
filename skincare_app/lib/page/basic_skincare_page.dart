...
class basicskincare extends StatefulWidget {
  const basicskincare({Key? key}) : super(key: key);
...
class _basicskincareState extends State<basicskincare> {
  Future<List<basic_skin>> ReadJsonData() async {
    final jsonData =
        await rootBundle.rootBundle.loadString('assets/data/skincare.json');
    final list = json.decode(jsonData) as List<dynamic>;
    return list.map((e) => basic_skin.fromJson(e)).toList();
  }
          ...
          child: FutureBuilder(
              ...
              builder: (context, data) {
                if (data.hasError) {
                  ...
                  var items = data.data as List<basic_skin>;
